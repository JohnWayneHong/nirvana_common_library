package com.ggb.common_library.router.plugin.base;

import com.ggb.common_library.router.model.RouterCommand;
import com.ggb.common_library.router.plugin.LoginPlugin;
import com.ggb.common_library.router.plugin.WebPlugin;
