package com.ggb.common_library.base.adapter;
...
import com.ggb.common_library.utils.click_utils.listener.OnPackageLoadMoreListener;
...
public abstract class CustomRecyclerAdapter<T> extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    /**
     * 脚界面Item
     * 改用{@link com.ggb.common_library.base.view.CustomRecyclerViewContainer}实现空布局时
